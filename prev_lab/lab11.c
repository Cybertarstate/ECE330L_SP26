...
char Message[] =
		...
		CHAR_B,CHAR_U,CHAR_F,CHAR_F,CHAR_A,SPACE,CHAR_L,CHAR_O,SPACE,CHAR_S,CHAR_O,CHAR_L,CHAR_D,
		CHAR_I,CHAR_E,CHAR_R,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE};
